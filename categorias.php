...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar">
        <div class="row container d-flex">
          ...
          <div class="nav-list d-flex">
            ...
            <a href="categorias.php"><div class="active">Tienda</div></a>
    ...
    <section class="section collection">
      ...
      <?php
    //get rows query
    $query = $conexion->query("SELECT * FROM pro_mujer ORDER BY id DESC LIMIT 10");
    if ($query->num_rows > 0) {
               ...
               <div class="product">
                ...
                <div class="bottom">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="price">
                    <a class="btn btn-success" href="AccionCarta_mujer.php?action=addToCart&id=<?php echo $row["id"]; ?>">Enviar al Carrito</a>
                    </div>
                    <div class="rating">
