...
<a href="proveedor_agregar.php"><input  class="btn btn-primary" type="button" value="Agregar Proveedor"></a>
</div>
<div class="col-sm-12">
...
extract($_POST);
$sql = "SELECT * FROM proveedores WHERE categorias = '$categoria'";
...
<td>
  ...
  <a>|</a>
  <a href="proveedor_eliminar.php?id=<?php echo $row['id']?>">
    <div">
    Eliminar
    </div>
  </a>
